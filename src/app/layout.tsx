...
export const metadata: Metadata = {
  title: "PhoneHub - Premium Smartphones & Mobile Devices",
  description: "Discover the latest flagship smartphones from top brands. Shop original phones with warranty, trade-in options, and expert support.",
  keywords: "smartphones, mobile phones, flagship phones, phone retailer, buy phones online",
  metadataBase: new URL("https://phonehub.com"),
  alternates: {
    canonical: "https://phonehub.com"
  },
  openGraph: {
    title: "PhoneHub - Premium Smartphones",
    description: "Shop authentic smartphones from leading brands with warranty and support",
    url: "https://phonehub.com",
    siteName: "PhoneHub",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_359Uh0VXrxxSKLlnHl6PZg7ckgh/uploaded-1765893707620-w6yo87yl.jpg",
  ...
  twitter: {
    ...
    title: "PhoneHub - Premium Smartphones",
    description: "Shop authentic smartphones from leading brands",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_359Uh0VXrxxSKLlnHl6PZg7ckgh/uploaded-1765893707620-w6yo87yl.jpg"]
  },
  robots: {
    index: true,
    follow: true
